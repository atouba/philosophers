...
/*   Updated: 2022/07/27 20:16:08 by atouba           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_set_args(t_philo *phs, char **av,
					pthread_mutex_t *mtxs, t_shared_data *shared);
void			all_point_to(t_philo *philos,
					t_shared_data *shared, pthread_mutex_t *mtxs);
